...
#ifndef FRIDAYFILEPROVIDER_SWIFT_H
#define FRIDAYFILEPROVIDER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FridayFileProvider",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18FridayFileProvider22FileProviderEnumerator")
...
- (void)enumerateChangesForObserver:(id <NSFileProviderChangeObserver> _Nonnull)observer fromSyncAnchor:(NSFileProviderSyncAnchor _Nonnull)anchor;
...
/// library (<code>/api/files</code>) as a location in the Files app. Thread workspaces are
/// handled in-app and are intentionally not exposed here.
SWIFT_CLASS("_TtC18FridayFileProvider21FileProviderExtension")
...
SWIFT_CLASS("_TtC18FridayFileProvider16FileProviderItem")
