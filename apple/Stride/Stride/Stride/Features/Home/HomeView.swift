...
struct HomeView: View {
    ...
    var body: some View {
        NavigationSplitView(
            ...
            Group {
                ...
                } else if store.isAutomations {
                    AutomationsView(store: store.scope(state: \.automations, action: \.automations))
                } else {
    ...
    private var detail: some View {
        if store.isFiles {
            ...
            AutomationDetailView(store: store.scope(state: \.automations, action: \.automations))
        ...
        List(selection: scopeBinding) {
            ...
            Section("Library") {
                ...
                Label("Automations", systemImage: "bolt.horizontal.circle")
                    .tag(HomeFeature.State.SidebarSelection.automations)
            }
        }
        .listStyle(.sidebar)
        .navigationTitle("S.T.R.I.D.E.")
        .toolbar {
...
private struct ChatEmptyState: View {
    ...
    var body: some View {
        ContentUnavailableView {
            Label("S.T.R.I.D.E.", systemImage: "sparkles")
        } description: {
