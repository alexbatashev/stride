...
mod tests {
    ...
    fn web_prompt_keeps_relative_links_without_telegram_section() {
        ...
        assert!(prompt.contains("user skill bundles are read-write under `/home/user/skills`"));
        assert!(
            prompt
